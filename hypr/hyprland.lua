...
hl.monitor({
	output = "eDP-1",
	mode = "1366x768@59.98900 at 0x03F8",
	position = "auto",
	scale = "auto",
})
hl.monitor({
	output = "HDMI-A-1",
	mode = "1920x1080@60.00000 at 1366x0",
	position = "0x0",
	scale = "auto",
	reserved_area = {
		top = 28,
...
local music = "ghostty --title=youtube-music-cli -e /home/lautaro/.config/hypr/scripts/youtube-music-cli.sh"
local coding = "ghostty --title=dev -e /home/linuxbrew/.linuxbrew/bin/herdr"
...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("awww img /home/lautaro/Pictures/wallpapers/default.jpg")
	hl.exec_cmd("eww daemon")
	hl.exec_cmd("/home/lautaro/.config/eww/scripts/launch-widgets.sh")
	hl.exec_cmd("/home/lautaro/.config/hypr/scripts/easyeffects-setup.sh")
	hl.exec_cmd("python3 /home/lautaro/.config/eww/scripts/mirror-volume-to-hardware.py")
end)
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(27345Cff)", "rgba(7FB4CAff)" }, angle = 45 },

			inactive_border = "rgba(27345C99)",
		},
	...
	decoration = {
		...
		-- Dim unfocused windows so the active one pops against the blur
		dim_inactive = true,
		dim_strength = 0.15,
		dim_special = 0.2,
...
-- Softer, more relaxed spring for a glass-y feel (less bounce, gentler settle)
hl.curve("relaxed", { type = "spring", mass = 1, stiffness = 55, dampening = 18 })

hl.animation({ leaf = "global", enabled = true, speed = 10, bezier = "default" })
hl.animation({ leaf = "border", enabled = true, speed = 5.39, bezier = "easeOutQuint" })
hl.animation({ leaf = "windows", enabled = true, speed = 5.2, spring = "relaxed" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.5, spring = "relaxed", style = "popin 87%" })
...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(coding))
...
-- Area screenshot: select a region with slurp, save it to ~/Pictures, and
-- copy it to the clipboard.
hl.bind("Print", hl.dsp.exec_cmd("/home/lautaro/.config/hypr/scripts/screenshot-area.sh"))
...
-- Extend the glass look beyond windows: blur waybar and rofi too
hl.layer_rule({
	name = "blur-waybar",
